...
public class Whiteboard_PaintReciever : MonoBehaviour {
    ...
    public void CreateSplash(Vector2 uvPosition, Whiteboard_Stamp stamp, Color color, float stampRotation = 0f)
    {
    ...
    public void DrawLine(Whiteboard_Stamp stamp, Vector2 startUVPosition, Vector2 endUVPosition, float startStampRotation, float endStampRotation, Color color, float spacing)
    {
    ...
    private void PaintOver(Whiteboard_Stamp stamp, Color32 color, Vector2 uvPosition)
    {
