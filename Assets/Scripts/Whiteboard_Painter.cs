...
public class Whiteboard_Painter : MonoBehaviour {
    ...
    private Whiteboard_Stamp stamp;

    private Color color;

    private Vector2? lastDrawPosition = null;

    public void Initialize(Whiteboard_PaintReciever newPaintReceiver)
    {
        stamp = new Whiteboard_Stamp(brush);
